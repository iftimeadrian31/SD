...
public class FetchCursListServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        responseText.append("<table border='1'><thead><tr><th>ID</th><th>Nume</th><th>Profesor</th></thead>");
        responseText.append("<tbody>");

        // preluare date studenti din baza de date
        TypedQuery<CursEntity> query = em.createQuery("select curs from CursEntity curs", CursEntity.class);
        ...
        for (CursEntity curs : results) {
            ...
            responseText.append("<tr><td>" + curs.getId() + "</td><td>" +
                    curs.getNume() + "</td><td>" + curs.getProfesor() + "</td></tr>");
        }
